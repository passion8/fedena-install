...
tar xzf rubygems-1.3.7.tgz &&  sudo ruby rubygems-1.3.7/setup.rb
...
sudo rm -rf /var/lib/gems/1.8/gems/rake-10.0.4/ 
sudo rm -rf /var/lib/gems/1.8/cache/rake-10.0.4.gem
sudo rm -rf /var/lib/gems/1.8/specifications/rake-10.0.4.gemspec